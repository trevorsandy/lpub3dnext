    ...
    switch (type) {
      case EXPORT_PNG:
		...
		ldrData << "1 216 2 -4 32 -1 0 0 0 0.423 -0.906 0 -0.906 -0.423 3070bptn.dat";
		ldrData << "1 216 -18 -4 32 -1 0 0 0 0.423 -0.906 0 -0.906 -0.423 3070bptg.dat";	  
        break;
      case EXPORT_JPG:	 
	  	ldrData << "1 216 22 -4 32 -1 0 0 0 0.423 -0.906 0 -0.906 -0.423 3070bptj.dat";
		ldrData << "1 216 2 -4 32 -1 0 0 0 0.423 -0.906 0 -0.906 -0.423 3070bptp.dat";
		ldrData << "1 216 -18 -4 32 -1 0 0 0 0.423 -0.906 0 -0.906 -0.423 3070bptg.dat";
        break;
      case EXPORT_BMP:
	  	ldrData << "1 216 22 -4 32 -1 0 0 0 0.423 -0.906 0 -0.906 -0.423 3070bptb.dat";
		ldrData << "1 216 2 -4 32 -1 0 0 0 0.423 -0.906 0 -0.906 -0.423 3070bptm.dat";
		ldrData << "1 216 -18 -4 32 -1 0 0 0 0.423 -0.906 0 -0.906 -0.423 3070bptp.dat";
        break;
      default:	  
	    ldrData << "1 216 22 -4 32 -1 0 0 0 0.423 -0.906 0 -0.906 -0.423 3070bptp.dat";
