...
`> CD %USERPROFILE%`
- [ ] 2. get lpub3d source  
`> git clone https:\\github.com\trevorsandy\lpub3dnext.git`
- [ ] 3. enter source directory and execute package script  
`> CD lpub3dnext & CALL builds\windows\AutoBuild.cmd -x86 -3rd -ins -chk`
...
`PS...> bash curl -sL https://raw.githubusercontent.com/trevorsandy/lpub3dnext/master/builds/linux/docker-compose/docker-compose-cibuild-linux.yml -o docker-compose-cibuild-linux.yml`
- [ ] 3. download Dockerfile yml  
`PS...> bash curl -sL https://raw.githubusercontent.com/trevorsandy/lpub3dnext/master/builds/linux/docker-compose/dockerfiles/Dockerfile-cibuild-fedora -o dockerfiles/Dockerfile-cibuild-fedora`
...
[dockercomposefile]: https://github.com/trevorsandy/lpub3dnext/blob/master/builds/linux/docker-compose/docker-compose-cibuild-linux.yml
[dockerarch]:        https://github.com/trevorsandy/lpub3dnext/blob/master/builds/linux/docker-compose/dockerfiles/Dockerfile-cibuild-archlinux
[dockerubuntu]:      https://github.com/trevorsandy/lpub3dnext/blob/master/builds/linux/docker-compose/dockerfiles/Dockerfile-cibuild-ubuntu
[dockerfedora]:      https://github.com/trevorsandy/lpub3dnext/blob/master/builds/linux/docker-compose/dockerfiles/Dockerfile-cibuild-fedora
[dockerrepo]:        https://hub.docker.com/r/trevorsandy/lpub3dnext/
...
[travis-ci]:         https://travis-ci.org/trevorsandy/lpub3dnext
[appveyor-ci]:       https://ci.appveyor.com/project/trevorsandy/lpub3dnext
[gh-rel-badge]:      https://img.shields.io/github/release/trevorsandy/lpub3dnext.svg

[gh-rel-2.1.0-url]:  https://github.com/trevorsandy/lpub3d/releases/v2.3.9
[gh-rel-url]:        https://github.com/trevorsandy/lpub3dnext/releases/latest
...
Copyright (c) 2015 - 2020 by Trevor SANDY
