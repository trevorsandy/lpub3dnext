...
public:
  ...
  {
    _result = _value[pushed];
    if (_result.type == ConstrainData::ConstrainWidth ||
        _result.type == ConstrainData::ConstrainHeight) {
...
class SubModelMeta  : public AssemMeta
{
public:
  UnitsMeta         size;
  ...
  SubModelMeta();
  SubModelMeta(const SubModelMeta &rhs) : AssemMeta(rhs)
  {
  }
...
class OneToOneMeta  : public PliMeta
{
public:
  OneToOneMeta();
  OneToOneMeta(const OneToOneMeta &rhs) : PliMeta(rhs)
  {
  }

  virtual ~OneToOneMeta() {}
  virtual void init(BranchMeta *parent, QString name);
};

/*------------------------*/

class RightWrongMeta  : public PliMeta
{
public:
  PointerMeta              pointer;    // keeping pointer for now
  ...
  FloatMeta                zfar;
  RightWrongMeta();
  RightWrongMeta(const RightWrongMeta &rhs) : PliMeta(rhs)
  {
  }

  virtual ~RightWrongMeta() {}
  virtual void init(BranchMeta *parent, QString name);
};
...
class PartIDMeta  : public PagePointerMeta
{
public:
      FreeFormMeta        freeform;
      AllocMeta           alloc;
  ...
  FloatPairMeta       angle;
  PartIDMeta();
  PartIDMeta(const PartIDMeta &rhs) : PagePointerMeta(rhs)
  {
  }
...
class IllustrationMeta  : public PagePointerMeta
{
public:
  ConstrainMeta            constrain;
  FreeFormMeta             freeform;
  ...
  FloatMeta                zfar;
  IllustrationMeta();
  IllustrationMeta(const IllustrationMeta &rhs) : PagePointerMeta(rhs)
  {
  }

  virtual ~IllustrationMeta() {}
  virtual void init(BranchMeta *parent, QString name);
};

/*------------------------*/

class StickerMeta  : public PagePointerMeta
{
public:
  FreeFormMeta        freeform;
  AllocMeta           alloc;
  ...
  FloatMeta           zfar;
  StickerMeta();
  StickerMeta(const StickerMeta &rhs) : PagePointerMeta(rhs)
  {
  }
...
public:
  ...
  RcMeta              end;
  AllocMeta           alloc;
  OneToOneMeta        oneToOne;
  PartIDMeta          partID;
  SubModelMeta        subModel;
  StickerMeta         sticker;
  RightWrongMeta      rightWrong;
  IllustrationMeta    illustration;
