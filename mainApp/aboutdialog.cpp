	...
	ui(new Ui::AboutDialog)
{
                                  ...
                                  "<table>"
                                     "<tr>"
                                       "<td>"
                                         ...
                                         "Portions of %1 are based on Kevin Clague's LPub&copy;<br>"
                                         "incorporating LeoCAD&copy; to render 3D visualization.<br>"
                                       "</td>"
                                       "<td>"
                                         "<a href=\"%5\"><img src=\":/resources/ldrawlogo.png\" alt=\"ldraw logo\" align=\"middle\"></a>"
                                         "<br><br>"
                                         "<a href=\"%6\"><img src=\":/resources/gplv3.png\" alt=\"gpl v3\" align=\"middle\"></a>"
                                       "</td>"
                                    "</tr>"
                                  "</table>"
                                "</td>"
    ...
    QString About = AboutFormat.arg(QString::fromLatin1(VER_PRODUCTNAME_STR))
                               ...
                               .arg(QString("http://www.ldraw.org"));
