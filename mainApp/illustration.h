...
class Pointer;
class IllustrationPointerItem;
class IllustrationItem;

class Illustration : public Steps
{
public:
  Step              *parentStep;
  ...
  QList<IllustrationPointerItem *> graphicsPointerList;

  IllustrationItem  *background;
  QGraphicsRectItem *underpinnings;
  Where              topIllustration,bottomIllustration;

  Where &topOfIllustration()
  {
    return topIllustration;
  }
  Where &bottomOfIllustration()
  {
    return bottomIllustration;
  }
  void setTopOfIllustration(const Where &topOfIllustration)
  {
    topIllustration = topOfIllustration;
  }
  void setBottomOfIllustration(const Where &bottomOfIllustration)
  {
    bottomIllustration = bottomOfIllustration;
  }
...
class IllustrationItem : public PlacementBackgroundItem
{
public:
  Illustration       *illustration;
  IllustrationMeta    illustrationMeta;
  QRect               illustrationRect;
  QRect               csiRect;
  AllocMeta          *alloc;
  PageMeta           *page;
...
class IllustrationPointerItem : public PointerItem
{
public:
  IllustrationPointerItem(
    Illustration  *il,
    Meta          *meta,
    Pointer       *pointer,
