...
{ //                    	      Page | Csi | Pli | Pn | Sn | Callout | ph | pf | Ms
  ...
  /* 24 rotateIcon                      */Page | Csi | Pli | Pn | Sn | Callout | ph | pf,

  /* 25 pagePointer                     */Page | Csi,
  /* 26 OneToOneType                      */Page | Csi | Pli | Pn | Sn | Callout,
  /* 27 PartIDType                      */Page | Csi | Pli | Pn | Sn | Callout,
  /* 28 SubModelType                    */Page | Csi | Pli | Pn | Sn | Callout,
  /* 29 IllustrationType                */Page | Csi | Pli | Pn | Sn | Callout,
  /* 30 RightWrongType                  */Page | Csi | Pli | Pn | Sn | Callout,
  /* 31 StickerType                     */Page | Csi | Pli | Pn | Sn | Callout,

  /* 32  SingleStep                      */Page | Csi,
  /* 33  SubmodelInstance                */Page | Csi | Pli | Pn | Sn,
  /* 34  Step                            */Page,
  /* 35  Range                           */Page,
  /* 36  Reserve                         */Page,
  /* 37  Bom                             */Page,
...
const int PlacementDialog::prepositionOks[NumRelatives] = // indexed by them
{
    ...
    /* 24 rotateIcon */  OutsideOk,
    /* 25 pagePointer */ OutsideOk,

    /* 26 OneToOneType */       OutsideOk,
    /* 27 PartIDType */       OutsideOk,
    /* 28 SubModelType */     OutsideOk,
    /* 29 IllustrationType */ OutsideOk,
    /* 30 RightWrongType */   OutsideOk,
    /* 31 StickerType */      OutsideOk,

    /* 32 SingleStep */  OutsideOk,
    /* 33 SubmodelIns */ OutsideOk,
    /* 34 Step     */    OutsideOk,
    /* 35 Range     */   OutsideOk,
    /* 36 Reserve     */ OutsideOk,
    /* 37 Bom */         OutsideOk,
    /* 38 CoverPage */   InsideOk,
